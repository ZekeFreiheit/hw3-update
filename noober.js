function pageLoad() {
  ...
  // passenger1DropoffAddressLine1, passenger1DropoffAddressLine2
    ...
    passenger1DropoffAddressLine2 = `${ride[0].dropoffLocation.city}, ${ride[0].dropoffLocation.state} ${ride[0].pickupLocation.zip}`
  }
  ...
  // passenger2DropoffAddressLine1, passenger2DropoffAddressLine2
    ...
    passenger2DropoffAddressLine2 = `${ride[1].dropoffLocation.city}, ${ride[1].dropoffLocation.state} ${ride[1].pickupLocation.zip}`
  }
  ...
  // passenger3DropoffAddressLine1, passenger3DropoffAddressLine2
    ...
    passenger3DropoffAddressLine2 = `${ride[2].dropoffLocation.city}, ${ride[2].dropoffLocation.state} ${ride[2].pickupLocation.zip}`
